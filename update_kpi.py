...
# Dataset público y ACTUALIZADO de Our World in Data (vivo hoy)
url = "https://raw.githubusercontent.com/owid/owid-data/master/world-development-indicators/world_development_indicators.csv"
